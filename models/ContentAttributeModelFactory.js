...
define(
[
    'models/ContentAttribute/SingleLineInputBoxModel',
    'models/ContentAttribute/MultipleChoiceModel',
    'models/ContentAttribute/MultilineInputBoxModel',
    'models/ContentAttribute/DescriptiveTextModel',
    'models/ContentAttribute/IdentityVerificationModel',
    'models/ContentAttribute/ContentReviewModel'
],
function(SingleLineInputBoxModel, MultipleChoiceModel, MultilineInputBoxModel,
    ...
    return {
        ...
        getInstance: function(typeId, attributes, options) {
            ...
            throw 'Unknown Content Attribute Model type: "' + typeId + '"';
        }
    }
});